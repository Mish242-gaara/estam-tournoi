...
export async function POST(req) {
  ...
  const rows = await sql`
    ...
    VALUES (${body.date ?? null}, ${body.time ?? null}, ${body.teamA}, ${body.teamB}, ${body.scoreA}, ${body.scoreB}, ${body.group}, ${body.status}, ${body.minute ?? null}, ${body.phase || "groupes"}, ${body.winner || null}, ${body.slot ?? null})
    RETURNING *`;
